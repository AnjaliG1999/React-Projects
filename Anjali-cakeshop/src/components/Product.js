                ...
                <form className="g-3" onSubmit={this.validateInfo}>
                        <div className="row">
                            <div className="col-6">
                                ...
                                <input type="text" className="form-control" id="cakeName" name="cakeName" placeholder="Enter Cake Name" />
                                {this.state.errors && <div className="text-danger">{this.state.errors.cakeName}</div>}
                            </div>
                            <div className="col-6">
                            <label htmlFor="flavour">flavour</label>
                                ...
                                {this.state.errors && <div className="text-danger">{this.state.errors.flavour}</div>}
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-6">
                                <label htmlFor="description" className="form-label">Cake Description</label>
                                <textarea className="form-control" id="description" rows="3"></textarea>
                                {this.state.errors && <div className="text-danger">{this.state.errors.description}</div>}
                            </div>
                            <div className="col-6">
                                <label htmlFor="ingredients" className="form-label">Ingredients</label>
                                <textarea className="form-control" id="ingredients" rows="3"></textarea>
                                {this.state.errors && <div className="text-danger">{this.state.errors.ingredients}</div>}
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-4">
                                <label htmlFor="weight">Weight (in pounds)</label>
                                <input type="number" min="1" max="5" className="form-control" id="weight" placeholder="What cake size are you looking for?" name="weight" />
                                {this.state.errors && <div className="text-danger">{this.state.errors.weight}</div>}
                            </div>
                            <div className="col-4">
                            ...
                            <div className="col-4">
                                ...
                                <input type="number" id="price" name="price" className="form-control" placeholder="Price in Rupees"/>
                                {this.state.errors && <div className="text-danger">{this.state.errors.price}</div>}
                            </div>
                        </div>
                        <br />
                        <div className="row">
                            <div className="eggless">
                                <input className="form-check-input" type="checkbox" id="eggless" />
                        ...
                        <div className="row imgDiv">
                            ...
                            <div className="mb-3 col-4">
                                <input className="form-control" type="file" id="cakeImage" onChange={this.uploadImage} />
                                {this.state.errors && <div className="text-danger">{this.state.errors.cakeImage}</div>}
                            </div>
                            <div className="mb-3 col-4 imageChoosen">
                                {this.state.file && <img src={this.state.file} width="150px" />}
                            </div>
                        </div>
                        <button type="submit" className="btn btn-success">Add Cake</button>
                    </form>
            </div>
        )
    }
