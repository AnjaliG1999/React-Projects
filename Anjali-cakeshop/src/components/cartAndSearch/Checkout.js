            ...
            if(Object.keys(this.state.errors).length === 0) {
                ...
                axios({
                    ...
                    if(response.data.messageg === "order placed"){
                        ...
                        this.props.history.push('/ordersuccess', "success")
                    }
                }, (error) => {
                    console.log(error);
                })
    ...
    render() {
        return (
            <div className="row" style={{marginTop:"10px"}}>
                ...
                <div className="col-4" style={{border:"1px solid black", padding:"10px", borderRadius:"5px", backgroundColor:"#2b1d0e", color:"white"}}>
                ...
                <form onSubmit={this.validateDetails}>
                    ...
                    <div class="row">
                        <div className="form-group col-md-6 text-danger">{this.state.errors.city}</div>
                        <div className="form-group col-md-6 text-danger">{this.state.errors.pincode}</div>
                    </div>
