    ...
    return (
        <div className="Cart">
            <div className="container" id="Cart">
                {cartList && cartList.length > 0 && <div className="row">
                    <div className="col-8">
                        <h1 style={{ textAlign: "center" }}>Your Cart</h1>
                        {
                            cartList.map(item => {
                                ...
                                totalItems += 1
                                return <CartItem cakesData={item} removeCartItem={removeCartItem} fromLocation={"cart"} />
                            })
                        }
                    ...
                    <div className="checkoutContainer col-4">
                        ...
                        <button onClick={addAddress} className="btn btn-primary checkout">Checkout</button>
                    </div>
                </div>}
                <div>
                    {
